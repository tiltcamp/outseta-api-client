    ...
    describe('Accounts', () => {
      describe('extendTrial', () => {
        ...
        it('handles successful request', async () => {
          ...
          const response = await accounts.extendTrial('jW7GJVWq', new Date('12/29/2021'));
        ...
        it('handles validation errors', async () => {
          ...
          const response = await accounts.extendTrial('jW7GJVWq', new Date('12/29/2021')) as ValidationError<Subscription>;
        ...
        it('throws failed request', async () => {
          ...
          try {
            response = await accounts.extendTrial('jW7GJVWq', new Date('12/29/2021'));
          } catch (e) {
            exception = e;
          }
